...
const Sidebar = ({data}) => {
  ...
  return (
    <div className='bg-zinc-900 p-4 rounded flex flex-col items-center justify-between h-auto lg:h-[90%]'>
     <div className='flex items-center flex-col justify-center'>{" "}
     <img src={data.profile} className='h-[10vh]'/>
     ...
     { role === 'admin' && (
      <div className='w-full flex-col items-center justify-center hidden lg:flex'>
      <Link to="/profile" className='text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-700 rounded transition-all'>
        All Orders
      </Link>
      <Link to="/profile/addbook" className='text-zinc-100 font-semibold w-full py-2 mt-4 text-center hover:bg-zinc-700 rounded transition-all duration-300'>
       Add Book
      </Link>
